...
@php
$page_title =  Session::get('cms_name') . "| My Orders";
@endphp
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    @foreach ($orders as $key => $item)
                        ...
                        <a href="/preview-order-ereceipt/{{ $item->order_no }}" class="btn btn-info" role="button" target="_blank">View Order Receipt</a><br>
