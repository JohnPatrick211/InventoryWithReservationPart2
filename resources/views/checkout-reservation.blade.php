      ...
      <div class="container shopping-cart">
        <div class="row mt-5">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                    <h3>Reservation Checkout (<span class="reservation-count"></span> items)</h3>
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a id="btn-place-order-reservation" class="btn btn-primary btn-sm mt-3">Place Reservation</a>
...
<script src="{{asset('js/checkout-reservation.js')}}"></script>
