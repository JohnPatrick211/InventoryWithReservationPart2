...
@php
$page_title =  Session::get('cms_name') . "| Edit Account";
@endphp
                    ...
                    <form action="{{ route('account.update',$user->id) }}" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 mt-2">
                                <label class="col-form-label">Student Id/No.</label><br>
                                <input name="studentId" class="form-control" value="{{ $user->student_id }}"  maxLength="11">
                            </div>
                            <div class="col-sm-12 col-md-6 mt-2">
