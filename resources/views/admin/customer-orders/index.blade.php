...
<div class="page-header">
    <h3 class="mt-2" id="page-title">Student Orders</h3>
    <hr>
</div>
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-pills" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pre-order-tab" data-toggle="tab" href="#pre-order" role="tab"
                            aria-controls="pre-order" aria-selected="true">Pre-Order</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="reservation" role="tabpanel"
                        ...
                        <div class="mt-4">
                            <table class="table table-hover" id="tbl-reservation-order">
                                <thead>
                                    <tr>
                                        <th>Order #</th>
                                        <th>Student Name</th>
...
<div class="modal fade bd-example-modal-lg" id="userInfoModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 mt-2">
                        ...
                        <img type="text" class="img-thumbnail" width="100%" name="identification_photo"
                            id="identification_photo">
                    </div>

                    <div class="col-sm-12 mt-2">
                        <label class="col-form-label">Customer's Photo with ID</label>
                        <img type="text" class="img-thumbnail" width="100%" name="selfie_with_identification_photo"
                            id="selfie_with_identification_photo">
                    </div>
