...
<div class="page-header">
  <h3 class="mt-2" id="page-title">Reservation Report</h3>
  <hr>
</div>
  ...
  <div class="row mt-4">
    ...
    <div class="col-12">
        ...
        {{-- <div class="float-left mt-1 ml-3">
            <p>Total Reservation: <span style="font-size: 21px;">&#8369; <b id="txt-total-reservation"></b></span></p>
        </div> --}}


        <a class="btn btn-sm btn-outline-dark btn-preview-reservation float-right m-1">Print Preview</a>
        <a class="btn btn-sm btn-outline-success btn-download-reservation float-right m-1"><i class="fas fa-download"></i> Download PDF</a>
    </div>
        
    <div class="col-md-12 col-lg-12 mt-3">
      <div class="card">
          <div class="card-body">
              <table class="table table-hover tbl-reservation" >
                  <thead>
                      <tr>
                        <th>Product Code</th>
                        <th>Description</th>
