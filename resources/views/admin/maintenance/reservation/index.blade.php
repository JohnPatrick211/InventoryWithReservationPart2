@extends('admin.maintenance.reservation.layout')
...
<div class="page-header">
  <h3 class="mt-2" id="page-title">Reservation Maintenance</h3>
          <hr>
      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="nav nav-pills" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="shipped-tab" data-toggle="tab" href="#shipped" role="tab" aria-controls="shipped" aria-selected="false">Pick-Up</a>
                      </li>
                      <li class="nav-item">
