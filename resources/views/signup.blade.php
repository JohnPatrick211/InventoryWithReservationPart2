...
@php
$page_title =  Session::get('cms_name') . " | Sign Up";
@endphp
...
<div class="container registration-container">
  <div class="row py-5 align-items-center">
      ...
      <div class="col-md-5 pr-lg-5 mb-5 mb-md-0 ml-sm-0 ml-lg-5">
          <img src="images/{{Session::get('cms_undraw_img')}}" alt="" class="img-fluid mb-3 d-none d-md-block">
      </div>
                    ...
                    <div class="input-group-prepend">
                      <span class="input-group-text bg-white px-4 border-md border-right-0">
                        ...
                        <div class="custom-file"> 
                          ...
                          <label class="custom-file-label" for="user-identification-photo">Upload your Student ID for verification</label>
                        </div>
                      </div>
