...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $categoryid = Category::create($request->all())->name;

        $at->audit($this->module, 'Add New Category With Name: ' . $categoryid);
    ...
    public function update(Request $request, $id)
    {
        ...
        $at->audit($this->module, 'Category Update With Name: ' . $request->input('name'));
