...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       // $at->audit($this->module, 'Add');
        ...
        $suppliername = Supplier::create($request->all())->supplier_name;


        $at->audit($this->module, 'Add New Supplier With Name: ' . $suppliername);
    ...
    public function update(Request $request, $id)
    {
        ...
        $at->audit($this->module, 'Supplier Update With Name: ' . $request->input('supplier_name'));
